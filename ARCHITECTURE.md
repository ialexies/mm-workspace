...
- Mobile Platform: `docs/MOBILE_PLATFORM_DOCUMENTATION.md` (mobile docs index), `frontend/docs/ANDROID_STATUS_BAR_CONFIGURATION.md` (Android status bar setup), `frontend/docs/IOS_SETTINGS_FIX.md` (iOS configuration).
