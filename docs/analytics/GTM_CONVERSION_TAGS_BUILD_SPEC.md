...
- **GA4 Key Events** — `purchase_all_in`, `purchase_parent_voucher`, and `purchase_surf_camp` have all fired
  ...
  names (`purchase_hostel`, `purchase_tour`) don't exist yet since those tags aren't built.
